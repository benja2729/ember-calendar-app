...
function program1(depth0,data) {
  ...
  var buffer = '', stack1, hashTypes, hashContexts, options;
  data.buffer.push("\n    <div class=\"well\">\n    Your search rendered no results.\n    ");
  hashTypes = {};
  hashContexts = {};
  options = {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data};
  data.buffer.push(escapeExpression(((stack1 = helpers.partial || depth0.partial),stack1 ? stack1.call(depth0, "_crying-face", options) : helperMissing.call(depth0, "partial", "_crying-face", options))));
  data.buffer.push("\n    </div>\n  ");
  return buffer;
  }
